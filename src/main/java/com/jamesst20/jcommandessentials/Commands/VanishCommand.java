...
public class VanishCommand implements CommandExecutor {
	...
	public boolean onCommand(CommandSender cs, Command cmnd, String cmd,
		...
		if (args.length == 0) {
			...
			if (!Methods
					.hasPermissionTell(cs, "JCMDEss.commands.vanish.others")) {
				return true;
			}
